...
def Cloud(p, f, g, t, c, cho, r, triangulation = False, tt = [], implicit = False, lam = 0.5):
    ...
    This function calculates an approximation to the solution of wave equation in 2D using a Generalized Finite Differences scheme on unstructured clouds of points.
    ...
    Input parameters
        ...
        r           1 x 2           Array           Coordinates of the water drop-like function.
